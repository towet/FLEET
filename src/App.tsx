  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 pt-16 md:pt-20">
      ...
      <Routes>
        ...
        <Route path="/smart-alerts" element={<SmartAlerts setIsContactOpen={setIsContactOpen} />} />
        <Route path="/speed-monitoring" element={<SpeedMonitoring setIsContactOpen={setIsContactOpen} />} />
      ...
      {isQuoteOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-white rounded-2xl w-full max-w-2xl p-8 relative transform transition-all duration-300 scale-100 shadow-2xl animate-scaleIn">
            {/* Close Button */}
            <button
      ...
      {isContactOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md p-8 relative transform transition-all">
            {/* Close Button */}
            <button
            ...
            <div className="space-y-4">
              {/* WhatsApp */}
              <a
                href="https://wa.me/254798888658"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center p-6 bg-green-50 rounded-xl hover:bg-green-100 transition-all duration-300 group"
              >
                <div className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center flex-shrink-0 mr-6 group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                <div className="flex-grow">
                  <h3 className="text-xl font-semibold text-blue-600 mb-1">Telegram</h3>
                  <p className="text-blue-700">Message us on Telegram</p>
                </div>
              ...
              {/* Gmail */}
              <a
                href="mailto:dee3ayahmed25@gmail.com"
